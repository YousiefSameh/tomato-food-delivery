	...
	return (
		<header className="py-5 fixed top-0 left-0 right-0 z-40 bg-white shadow-md">	
			<div className="w-[80%] mx-auto flex justify-between items-center">
				<Link to="/"><img src={assets.logo} alt="Logo" className="w-[120px] md:w-[140px] lg:w-[150px]" /></Link>
				...
				<div className="flex items-center gap-5 md:gap-7.5 lg:gap-10">
					...
					<div className="relative">
						<Link to="/cart"><img src={assets.basket_icon} className="w-[20px] md:w-[22px] lg:w-fit" alt="basket icon" /></Link>
