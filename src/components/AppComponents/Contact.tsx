...
const Contact = () => {
  ...
  return (
    <div className="bg-white pb-24 sm:pb-32 lg:px-8" id='contact-us'>
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-4xl font-semibold tracking-tight text-balance text-tomato sm:text-5xl">Contact Us</h2>
      ...
      <form action="#" method="POST" className="mx-auto mt-16 sm:mt-20">
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          ...
          <div className="sm:col-span-2">
            ...
            <div className="mt-2.5">
              <div className="flex rounded-md bg-white outline-1 -outline-offset-1 outline-gray-300 has-[input:focus-within]:outline-2 has-[input:focus-within]:-outline-offset-2 has-[input:focus-within]:outline-tomato">
                <div className="grid shrink-0 grid-cols-1 focus-within:relative">
                  <select
                    ...
                    aria-label="Country"
                    className="col-start-1 row-start-1 w-full appearance-none rounded-md py-2 pr-7 pl-3.5 text-base text-gray-500 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-tomato sm:text-sm/6"
                  >
                    <option>EG</option>
                    <option>US</option>
                    <option>EU</option>
